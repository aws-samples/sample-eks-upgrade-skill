...
- **Provisioner/`v1alpha5` → NodePool/`v1beta1`** happened at **Karpenter v0.32** (the CRD kind renamed from `Provisioner` to `NodePool`). See https://karpenter.sh/v0.32/upgrading/v1beta1-migration/
